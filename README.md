...
Меня зовут **Дмитрий**, я студент-программист, который превращает идеи в работающий код. Мой путь в IT начался с желания создавать полезные и масштабируемые системы c упором в качество и удобство для пользователя. Сейчас я углубляюсь в бэкенд-разработку, devops-практики и AI-разработку.
